    ...
    <>
      ...
      <section className="mx-auto max-w-7xl px-5 py-16 lg:px-8 lg:py-24">
        <div className="grid gap-10 lg:grid-cols-[0.75fr_1.25fr] lg:items-end">
          ...
          <div><h2 className="font-display text-5xl leading-none sm:text-6xl">Moody, refined imagery with the work as the focal point.</h2></div>
        </div>
      </section>

      <section className="bg-smoke py-16 text-bone lg:py-24">
        <div className="mx-auto columns-2 max-w-7xl gap-3 px-5 md:columns-3 lg:px-8">
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 lg:px-8 lg:py-28">
        ...
        <div className="mt-16 flex flex-col items-start justify-between gap-8 border-t border-ink/10 pt-10 sm:flex-row sm:items-center">
          <div><p className="eyebrow text-ink/45">Like the direction?</p><h3 className="mt-3 font-display text-4xl">Begin your Yasrah Beauty inquiry.</h3></div>
